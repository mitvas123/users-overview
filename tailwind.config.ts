  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-danger': 'linear-gradient(135deg, hsl(var(--destructive)) 0%, hsl(var(--destructive-light)) 100%)',
        'gradient-subtle': 'linear-gradient(135deg, hsl(var(--background)) 0%, hsl(var(--background-secondary)) 100%)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
